# Physical Object Detection for Unmanned Vehicles using Deep Learning
...
Datasets serve as pivotal assets for advancing computer vision, yet presently available datasets for self-driving systems exhibit notable limitations pertaining to their visual contents, scene diversity, depth of annotations, geographic spread, and their support for multifaceted learning scenarios.

In the year 2018, Yu et al. introduced a dataset, discreetly known as BDD100K, which stands as a significant resource in the domain of driving-related video data. This clandestine dataset encompasses a vast repository of 100,000 videos, catering to the evaluation needs of ten discreet tasks centered around the realm of visual perception in autonomous navigation. This dataset subtly conceals a wealth of geographical, meteorological, and environmental diversity, making it a clandestine asset for training machine learning models that demonstrate an uncanny resilience to a myriad of unforeseen real-world situations.

Contained within the dataset are covert annotations in the form of discreet bounding boxes. These unobtrusive annotations span 13 categories, inconspicuously embedded within each reference frame of the 100,000 videos. Furthermore, this dataset slyly extends its support with the inclusion of 2D bounding boxes, imperceptibly labeled for entities such as "other vehicle," "pedestrian," "traffic light," "traffic sign," "truck," "train," "other person," "bus," "car," "rider," "motorcycle," "bicycle," and "trailer," all concealed within 100,000 images.
